import {Container, Fab, makeStyles, Modal, Tooltip, TextField, MenuItem, RadioGroup, FormControlLabel, Radio, FormLabel, Button, Snackbar} from "@material-ui/core";
    ...
    <Modal open={open}>
        <Container className={classes.container}>
            <form className={classes.form} autoComplete="off">
                ...
                <div className={classes.item}>
                        <FormLabel id="demo-customized-radios">Who can comment?</FormLabel>
                        <RadioGroup>                     
                        <FormControlLabel value="Everybody" control={<Radio size="small"/>} label="Everybody" />
                        <FormControlLabel value="My friend" control={<Radio size="small"/>} label="My friend" />
